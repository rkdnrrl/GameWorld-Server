...
const SMELT_CATALOG = [
  ...
  /** 단독 '철'은 "비철" 등에 오인 */
  { id: 'iron', name: '철괴', emoji: '⛓️', keywords: ['강철', '연철', '스테인리스', '스테인', 'iron', 'steel', '철근', '철판', '철사', '철망', '철창', '철퇴', '철심', '철벽', '철광', '철가루', 'scrap iron', '낚싯바늘', '낚시추', '열쇠', '자물쇠', '못', '볼트', '너트', '체인', '자석', '칼날', '가위', '칼', '도검', '검', '창', '방패', '갑옷', '총', '기계부품', '스프링', '코일', '철조망', '금고', '캔', '통조림', '냄비', '프라이팬', '포크', '나이프'] },
  {
    id: 'circuit',
    name: '회로합금',
    emoji: '🧩',
  ...
  { id: 'glass', name: '유리액', emoji: '🫙', keywords: ['유리', 'glass', '렌즈', 'lens', '안경', '선글라스', '고글', '병', '유리컵', '유리병', '거울', '수족관', '어항'] },
  { id: 'fiber', name: '광섬유편', emoji: '🧵', keywords: ['광섬유', 'fiber', 'fibre', '낚싯줄', '낚시줄', '실', '노끈', '로프', '줄', '끈', '밧줄', '케이블', '와이어'] },
  { id: 'ceramic', name: '세라믹분말', emoji: '🧱', keywords: ['도자기', '자기', 'porcelain', '세라믹', 'ceramic', '점토', 'clay', '그릇', '접시', '컵', '찻잔', '화분', '항아리', '옹기', '타일'] },
  ...
  { id: 'resin', name: '수지덩어리', emoji: '🪵', keywords: ['목판', '원목', '대나무', '나무자루', '수지', 'resin', '나무', 'wood', '목재', '낚싯대', '지팡이', '몽둥이', '나무판', '나무상자', '빗자루', '도마', '젓가락', '나무숟가락', '코르크'] },
  { id: 'rubber', name: '고무덩어리', emoji: '🛞', keywords: ['고무', 'rubber', '라텍스', 'latex', '고무장갑', '고무신', '고무오리', '풍선', '타이어', '지우개', '고무밴드', '고무줄'] },
  { id: 'plastic', name: '플라스틱편', emoji: '🧴', keywords: ['플라스틱', 'plastic', '폴리머', 'polymer', '페트병', '플라스틱병', '도시락통', '컵라면', '요구르트병', '플라스틱컵', '플라스틱통', '바구니', '트레이', '케이스', '헬멧', '마스크'] },
  {
    id: 'leather',
    name: '가죽편',
    emoji: '🥾',
  ...
  { id: 'keratin', name: '생체분말', emoji: '🦴', keywords: ['뼈', 'bone', '비늘', 'scale', '발톱', '뿔', 'horn', '조개껍데기', '소라껍데기', '거북이등', '갑피', '뿔소재', '뿔장식'] },
  { id: 'chitin', name: '키틴편', emoji: '🪲', keywords: ['키틴', 'chitin', '갑각', '게', '새우', '바닷가재', '갑각류', '곤충', '딱정벌레', '매미껍질', '허물'] },
  { id: 'protein', name: '단백질덩어리', emoji: '🥩', keywords: ['단백질', 'protein', '물고기', '생선', '조개', '문어', '오징어', '해삼', '성게', '해파리', '산호', '말미잘', '불가사리', '해양생물', '우주생물', '외계생명체', '고기', '육류', '버섯', '균류'] },
  { id: 'enzyme', name: '효소응집체', emoji: '🧫', keywords: ['효소', 'enzyme', '발효', '균', '세균', '박테리아', '바이러스', '포자', '균류', '효모', '곰팡이'] },
